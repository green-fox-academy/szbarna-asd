...
public class PartyIndicator {
    public static void main(String[] args) {
        for (int i = 0; i <4 ; i++) { //A program ellenőrzéséhez, hogy ne kelljen minden eyes új értéknél újraindítani a programot
            ...
            Scanner girls = new Scanner(System.in); //egy programban elég egy scanner --> így Scanner scanner = new
            ...
            if (numberOfBoys == numberOfGirls & (numberOfBoys + numberOfGirls) >= 20) { //kondíciók esetén figyelni a logikai sorrender!!
